...
type: command
description: >
  neurosymbolic-system's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in neurosymbolic-system, handling
...
# CI/CD — neurosymbolic-system edition
