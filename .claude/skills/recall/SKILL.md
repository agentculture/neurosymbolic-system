...
description: >
  ...
  defaults queries to this agent's PERSONAL, PRIVATE scope (`--scope neurosymbolic-system
...
- `--scope NAME` / `--visibility public|private` — scope isolation (no private
  ...
  (`--scope neurosymbolic-system --visibility private`, suffix read from `culture.yaml`),
