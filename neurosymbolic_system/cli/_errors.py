...
Every failure inside neurosymbolic-system raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`neurosymbolic_system.cli._output`,
...
# Exit-code policy. Documented in ``neurosymbolic-system learn`` output.
# 0      = success
