"""``neurosymbolic-system overview`` — read-only descriptive snapshot of the agent.
...
:mod:`neurosymbolic_system.cli._commands.cli`).
...
from neurosymbolic_system.cli._commands.whoami import report
